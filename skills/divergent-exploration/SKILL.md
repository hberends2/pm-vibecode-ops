...
- **Epic creation**: Before defining scope, explore different ways to solve the user problem
- **Architecture decisions**: Before choosing a pattern, explore genuinely different approaches
- **Feature design**: Before specifying requirements, explore alternative solutions
- **Technical decomposition**: Before breaking down work, explore different implementation strategies
- **Problem solving**: Before proposing fixes, explore root cause hypotheses

## The Three Phases

### Phase 1: Diverge (Generate Options)

Create 3-5 **genuinely distinct** approaches. Not variations on a theme—fundamentally different solutions.
...
### Phase 2: Evaluate (Analyze Trade-offs)
...
### Phase 3: Converge (Present and Decide)

Present options to the user with clear recommendations. Never decide for them on significant choices.
...
Divergent exploration isn't about being indecisive. It's about being **rigorous**. The first idea that comes to mind is often:
